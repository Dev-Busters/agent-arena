...
function rollRarity(rng) {
    const roll = rng();
    if (roll < RARITY_RATES.common)
        return 'common';
    if (roll < RARITY_RATES.uncommon)
        return 'uncommon';
    if (roll < RARITY_RATES.rare)
        return 'rare';
    if (roll < RARITY_RATES.epic)
        return 'epic';
    return 'legendary';
}
/**
 ...
 */
export function generateLoot(gold, xp, difficulty, depth, rng) {
